...
<table>
    ...
    if($dem > 0)
        while ($bien = mysqli_fetch_assoc($sql))
        {
?>
...
?>
	...
	<?php
			...
			$sql = "SELECT COUNT(*) as Num FROM hoadon";
			$total_results = mysqli_result(mysqli_query($conn, $sql),mysqli_num_rows(mysqli_query($conn, $sql)),0);  
