	...
	<div id="footer">
		...
		<div id="bg-footer">
			<div id="noidungfooter">
				...
				<div id="noidung">
					<ul>
						<li><span id="tencongty">Công Ty TNHH ĐIỆN THOẠI TIẾN DŨNG</span></li> <br>
						
						<li>Địa chỉ: Bà Điểm - Hóc Môn - TPHCM </li>
						<li>Điện thoại: 0972341193 - Hotline:  0972341193</li>
						<li>Email:  dienthoaitiendat@gmail.com</li>
					</ul>
				</div><!-- End .noidung -->
				<div id="thanhngang">
				...
				<div id="copyright">
					<p>Sinh Viên : Bùi Tiến Dũng | Lớp : DCT119C1 | Gmail : dungtien@gmail.com<p>
				</div><!-- End .copyright -->
